...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    -- VertSplit                              { fg="#767676" , bg="#262626" }, -- VertSplit      xxx ctermfg=243 ctermbg=243 guifg=#767676 guibg=#767676
    VertSplit                              { fg="#767676"  }, -- VertSplit      xxx ctermfg=243 ctermbg=243 guifg=#767676 guibg=#767676
    WinSeparator                           { VertSplit }, -- WinSeparator   xxx links to VertSplit
    FloatBorder                            { fg="#767676", bg="#262626"  }, -- VertSplit      xxx ctermfg=243 ctermbg=243 guifg=#767676 guibg=#767676
